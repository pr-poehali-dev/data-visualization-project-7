...
const translations = {
  en: {
    heading: "Contact",
    subheading: "Book a tour or ask a question",
    email: "Email",
    phone: "Phone",
    message: "Message",
    send: "Send Message",
  ...
  de: {
    heading: "Kontakt",
    subheading: "Tour buchen oder Frage stellen",
    email: "E-Mail",
    phone: "Telefon",
    message: "Nachricht",
  ...
  ru: {
    heading: "Контакты",
    subheading: "Запишитесь на тур или задайте вопрос",
    email: "Эл. почта",
    phone: "Телефон",
    message: "Сообщение",
    send: "Отправить",
    location: "Город",
    name: "Имя",
    successMessage: "Сообщение отправлено! Скоро свяжемся 🐻",
